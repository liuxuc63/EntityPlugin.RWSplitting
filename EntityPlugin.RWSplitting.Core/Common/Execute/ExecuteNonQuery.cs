...
namespace EntityPlugin.RWSplitting.Common
{
	public abstract partial class Database
    {
        ...
        {
            return DatabaseExtensions.ExecuteNonQuery(this.PrimitiveDatabase, command);
        }
        ...
        {
            return DatabaseExtensions.ExecuteNonQuery(this.PrimitiveDatabase, commandText);
        }
        ...
        /// <returns>表示脚本命令执行受影响的行数。</returns>
        public int ExecuteNonQuery(string commandText, params DbParameter[] parameterValues)
        {
            return DatabaseExtensions.ExecuteNonQuery(this.PrimitiveDatabase, commandText, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行受影响的行数。</returns>
        public int ExecuteNonQuery(DbTransaction transaction, string commandText, params DbParameter[] parameterValues)
        {
            return DatabaseExtensions.ExecuteNonQuery(this.PrimitiveDatabase, transaction, commandText, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行受影响的行数。</returns>
        public int ExecuteNonQuery(DbTransaction transaction, string commandText, params object[] parameterValues)
        {
            return DatabaseExtensions.ExecuteNonQuery(this.PrimitiveDatabase, transaction, commandText, parameterValues);
        }
        ...
        {
            return DatabaseExtensions.ExecuteNonQuery(this.PrimitiveDatabase, transaction, commandText, commandType);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行受影响的行数。</returns>
        public int ExecuteNonQuery(DbTransaction transaction, string commandText, CommandType commandType, params object[] parameterValues)
        {
            return DatabaseExtensions.ExecuteNonQuery(this.PrimitiveDatabase, transaction, commandText, commandType, parameterValues);
        }
