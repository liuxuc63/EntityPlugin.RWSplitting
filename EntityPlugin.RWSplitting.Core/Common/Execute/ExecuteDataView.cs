...
namespace EntityPlugin.RWSplitting.Common
{
	public abstract partial class Database
    {
        ...
        public virtual DataView ExecuteDataView(DbCommand command)
        {
            return DatabaseExtensions.ExecuteDataView(this.PrimitiveDatabase, command);
        }
        ...
        {
            return DatabaseExtensions.ExecuteDataView(this.PrimitiveDatabase, commandText);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行的结果的一个 <see cref="DataView"/> 对象。</returns>
        public DataView ExecuteDataView(string commandText, params object[] parameterValues)
        {
            return DatabaseExtensions.ExecuteDataView(this.PrimitiveDatabase, commandText, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行的结果的一个 <see cref="DataView"/> 对象。</returns>
        public DataView ExecuteDataView(string commandText, CommandType commandType, params DbParameter[] parameterValues)
        {
        ...
        /// <param name="commandText">表示要执行的 SQL 脚本文本内容。</param>
        /// <returns>表示脚本命令执行的结果的一个 <see cref="DataView"/> 对象。</returns>
        public DataView ExecuteDataView(DbTransaction transaction, string commandText)
        {
            return DatabaseExtensions.ExecuteDataView(this.PrimitiveDatabase, transaction, commandText);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行的结果的一个 <see cref="DataView"/> 对象。</returns>
        public DataView ExecuteDataView(DbTransaction transaction, string commandText, params DbParameter[] parameterValues)
        {
            return DatabaseExtensions.ExecuteDataView(this.PrimitiveDatabase, transaction, commandText, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行的结果的一个 <see cref="DataView"/> 对象。</returns>
        public DataView ExecuteDataView(DbTransaction transaction, string commandText, params object[] parameterValues)
        {
            return DatabaseExtensions.ExecuteDataView(this.PrimitiveDatabase, transaction, commandText, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行的结果的一个 <see cref="DataView"/> 对象。</returns>
        public DataView ExecuteDataView(DbTransaction transaction, string commandText, CommandType commandType, params object[] parameterValues)
        {
            return DatabaseExtensions.ExecuteDataView(this.PrimitiveDatabase, transaction, commandText, commandType, parameterValues);
        }
