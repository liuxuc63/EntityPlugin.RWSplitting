...
namespace EntityPlugin.RWSplitting.Common
{
	public abstract partial class Database
    {
        ...
        {
            return DatabaseExtensions.ExecuteReader(this.PrimitiveDatabase, command);
        }
        ...
        {
            return DatabaseExtensions.ExecuteReader(this.PrimitiveDatabase, commandText);
        }
        ...
        /// <returns>表示脚本命令执行的结果的一个 <see cref="IDataReader"/> 对象。</returns>
        public IDataReader ExecuteReader(string commandText, params DbParameter[] parameterValues)
        {
            return DatabaseExtensions.ExecuteReader(this.PrimitiveDatabase, commandText, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行的结果的一个 <see cref="IDataReader"/> 对象。</returns>
        public IDataReader ExecuteReader(DbTransaction transaction, string commandText, params DbParameter[] parameterValues)
        {
        ...
        /// <param name="commandType">表示一个 <see cref="CommandType"/> 值用于指示 <paramref name="commandText"/> 的类型。</param>
        /// <returns>表示脚本命令执行的结果的一个 <see cref="IDataReader"/> 对象。</returns>
        public IDataReader ExecuteReader(DbTransaction transaction, string commandText, CommandType commandType)
        {
            return DatabaseExtensions.ExecuteReader(this.PrimitiveDatabase, transaction, commandText, commandType);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行的结果的一个 <see cref="IDataReader"/> 对象。</returns>
        public IDataReader ExecuteReader(DbTransaction transaction, string commandText, CommandType commandType, params DbParameter[] parameterValues)
        {
            return DatabaseExtensions.ExecuteReader(this.PrimitiveDatabase, transaction, commandText, commandType, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行的结果的一个 <see cref="IDataReader"/> 对象。</returns>
        public IDataReader ExecuteReader(DbTransaction transaction, string commandText, CommandType commandType, params object[] parameterValues)
        {
            return DatabaseExtensions.ExecuteReader(this.PrimitiveDatabase, transaction, commandText, commandType, parameterValues);
        }
