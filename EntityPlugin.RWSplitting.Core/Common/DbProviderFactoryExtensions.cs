...
namespace EntityPlugin.RWSplitting.Common
{
	public static class DbProviderFactoryExtensions
    {
        ...
        internal static void CheckProviderNameRegisted(string providerName)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(Resource.UnregisteredProviderName, providerName));
            }
        }
        ...
        internal static string GetParemeterToken(string providerName)
        {
            ...
            {
                throw new ArgumentException(string.Format(Resource.UnregisteredProviderName, providerName), "providerName");
            }
