...
namespace EntityPlugin.RWSplitting.EnterpriseLibrary
{
	public static partial class DatabaseExtensions
    {
        ...
        {
            return ExecuteScalar(database, commandText, CommandType.Text);
        }
        ...
        {
            return ExecuteScalar(database, commandText, CommandType.Text, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行的查询所返回的结果集中的第一行第一列。所有其他的行和列将会被忽略</returns>
        public static object ExecuteScalar(Database database, string commandText, params object[] parameterValues)
        {
            return ExecuteScalar(database, commandText, CommandType.Text, parameterValues);
        }
        ...
        {
            return ExecuteScalar(database, transaction, commandText, CommandType.Text);
        }
        ...
        {
            return ExecuteScalar(database, transaction, commandText, CommandType.Text, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行的查询所返回的结果集中的第一行第一列。所有其他的行和列将会被忽略</returns>
        public static object ExecuteScalar(Database database, DbTransaction transaction, string commandText, params object[] parameterValues)
        {
            return ExecuteScalar(database, transaction, commandText, CommandType.Text, parameterValues);
        }
        ...
        public static object ExecuteScalar(this Database database, DbTransaction transaction, string commandText, CommandType commandType)
        {
            using (DbCommand command = CreateCommand(database, commandText, commandType))
            {
                return ExecuteScalar(database, transaction, command);
            }
        }
