...
namespace EntityPlugin.RWSplitting.EnterpriseLibrary
{
	public static partial class DatabaseExtensions
    {
        ...
        {
            return ExecuteDataTable(database, command).DefaultView;
        }
        ...
        {
            return ExecuteDataView(database, commandText, CommandType.Text);
        }
        ...
        {
            return ExecuteDataView(database, commandText, CommandType.Text, parameterValues);
        }
        ...
        public static DataView ExecuteDataView(this Database database, string commandText, CommandType commandType)
        {
            ...
            {
                return ExecuteDataView(database, command);
            }
        }
        ...
        {
            return ExecuteDataTable(database, transaction, command).DefaultView;
        }
        ...
        {
            return ExecuteDataView(database, transaction, commandText, CommandType.Text);
        }
        ...
        {
            return ExecuteDataView(database, transaction, commandText, CommandType.Text, parameterValues);
        }
        ...
        public static DataView ExecuteDataView(this Database database, DbTransaction transaction, string commandText, CommandType commandType)
        {
            using (DbCommand command = CreateCommand(database, commandText, commandType))
            {
                return ExecuteDataView(database, transaction, command);
            }
        }
