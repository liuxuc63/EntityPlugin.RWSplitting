...
{
	/// <summary>
	/// 为 <see cref="Database"/> 实例提供一组工具方法扩展。
	/// </summary>
	public static partial class DatabaseExtensions
    {
        ...
        {
            return Common.DbProviderFactoryExtensions.GetProviderName(database.DbProviderFactory);
        }
		...
		public static Common.DbScriptParameterParser GetDbScriptParameterParser(this Database database)
        {
            return Common.DbProviderFactoryExtensions.GetScriptParameterParser(database.DbProviderFactory);
        }
