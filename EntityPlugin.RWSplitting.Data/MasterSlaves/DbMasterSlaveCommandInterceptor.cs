...
namespace EntityPlugin.RWSplitting.MasterSlaves
{
	...
	public class DbMasterSlaveCommandInterceptor : DbCommandInterceptor
	{
		...
		internal DbMasterSlaveCommandInterceptor(Type contextType)
		{
			...
			ResetMasterSlaveContextConfig();
			RegisterAppConfigChangedEvent();
		}
		...
		{
			get { return Config.TargetContextType; }
		}
		...
		{
			DbMasterSlaveConfig.DefaultInstance.ConfigChanged += AppConfig_FileChanged;
		}
