...
namespace EntityPlugin.RWSplitting.MasterSlaves
{
	...
	public class DbMasterSlaveConfig : AppConfig
    {
		...
		/// <returns></returns>
		public static bool ToBoolean(string value, bool defaultValue, bool friendly = true)
		{
			if (friendly)
			{
		...
		private static bool GetUseDefaultConfigurationFile()
        {
            ...
            return ToBoolean(value,_Default_UseDefaultConfigurationFile);
        }
        ...
        private static bool GetEnableConfigChangedEvent()
        {
            ...
            return ToBoolean(value,_Default_EnableConfigChangedEvent);
        }
